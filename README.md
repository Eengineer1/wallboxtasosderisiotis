# Backend Challenge - Submission by Tasos Derisiotis Senior Lead Software Engineer
...
## Specs
Symfony Console Component v5.2
PHPUnit v9.5.2
Docker (Optional)

## Install
Access the root directory & run:
`composer install`

## Run
The application can be ran by accessing the root directory and running:
`php bin/console ev-organizer`

Otherwise, you can run the application through Docker by running:
